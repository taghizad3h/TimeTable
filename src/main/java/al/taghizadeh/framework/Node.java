package al.taghizadeh.framework;
...
public class Node<S, A> {
	 ...
	 *            the root'sa path costs plus the step costs for executing
	...
	/**
	 * Returns this node'sa parent node, from which this node was generated.
	 * 
	 * @return the node'sa parenet node, from which this node was generated.
	 */
