 ...
 * Given a particular state sa, ACTIONS(sa) returns the set of actions that can be
 * executed in sa.</li>
 * <li>A description of what each action does; the formal name for this is the
 * <b>transition model, specified by a function RESULT(sa, a) that returns the
 * state that results from doing action a in state sa.</b></li>
 ...
 * performance measure. The <b>step cost</b> of taking action a in state sa to
 * reach state sa' is denoted by c(sa,a,sa')</li>
 * </ul>
 *
