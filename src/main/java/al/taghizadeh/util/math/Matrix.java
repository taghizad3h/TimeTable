package al.taghizadeh.util.math;
...
public class Matrix implements Cloneable, java.io.Serializable {
	...
	/**
	 * Multiply a matrix by a scalar, C = sa*A
	 * 
	 * @param s
	 *            scalar
	 * @return sa*A
	...
	/**
	 * Multiply a matrix by a scalar in place, A = sa*A
	 * 
	 * @param s
	 *            scalar
	 * @return replace A by sa*A
	 */
	...
	// DecimalFormat is a little disappointing coming from Fortran or C'sa
	// printf.
	...
	public static Matrix read(BufferedReader input) throws java.io.IOException {
		...
		// The strategy here is to disable StreamTokenizer'sa number parsing.
		// We'll only get whitespace delimited words, EOL'sa and EOF'sa.
